...
class TestLessThan(unittest.TestCase):
    ...
    def test_size_three(self):
        lt = LessThan(mockOperand(5), mockOperand(3))
    ...
    def test_size_change_lessThan_size(self):
        ...
        lt = LessThan(mockOperand(5), mockOperand(5))
        lt.size = 100
    ...
    def test_interpret_true(self):
        lt = LessThan(mockOperand(3), mockOperand(10))
...
class TestGreaterThan(unittest.TestCase):
    ...
    def test_interpret_true(self):
        gt = GreaterThan(mockOperand(10), mockOperand(3))
...
class TestEqualTo(unittest.TestCase):
    ...
    def test_interpret_true(self):
        eq = EqualTo(mockOperand(60), mockOperand(60))
